...
|---|---|---|---|---|
| Three-layer system: LABEL → PRICE ENGINE → CUSTOMER DATA | Persistent visual spine | 03–11 | planned | Each layer lights only when evidence reaches it |
...
## Archival and Broadcast Leads

| Clip | Rights Tier | URL | Likely Use | Status |
|---|---|---|---|---|
| AP: Shoppers are wary of digital shelf labels | AMBER | https://youtu.be/YVjA2FuV7GI | Brief human-reaction / tag footage | identified |
...
- Evidence documents: **GREEN**—retailer pages, government reports/law, paper, and policy records are
  enough to prove every central factual turn.
- Exact ESL imagery: **GREEN/AMBER**—two CC BY photographs plus retailer and broadcast material.
- Human store footage: **AMBER but abundant**—broadcast and retailer footage exists; a rights-cleared
  generic shopper/worker bed still needs assembling.
- Explanatory graphics: **GREEN**—the decisive system distinction is best shown with original diagrams.
- Synthetic imagery need: **near zero**—no evidentiary beat requires AI generation.
- Overall feasibility: **PASS**. Rights clearance, not material scarcity, is the production constraint.

## Asset Risks

- Do not use a fake image of one public shelf tag showing two personalized prices; it would misstate
  how a shared display works.
