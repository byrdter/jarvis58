...
|---|---:|---|---|---|---|
| 06 | full scene | — | HyperFrames check: 0 runtime errors, 0 layout issues, 38/38 text contrast checks pass | none | pass |
| 06 | full scene | — | Motion scan: 106 events / 96.1 per minute; longest static interval 3.7s; visual bed passes | none | pass |
...
## Scene 06 Footage-Dominant Review Cut — 2026-08-20

- File: `05-hyperframes/renders/scene06-study-reversal-review-v5.mp4`
...
- Media treatment: seven licensed real grocery/Walmart clips occupy 52.73s; the full-screen authored
  result chart occupies 13.43s, a 3.93:1 real-footage-to-pure-graphics ratio; no AI imagery
- Editorial safeguard: the study retailer was unnamed, so generic study-adjacent footage carries a
  persistent `Illustrative grocery footage · study retailer unnamed` label
- HyperFrames lint note: Track 7 contains seven timed beat sections. This is acceptable for the one-scene
